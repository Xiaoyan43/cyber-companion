...
## 任务执行中必须遵守
- 优先读 `docs/HANDOFF.md`、`docs/TASK_QUEUE.md`、`docs/ARCHITECTURE_SNAPSHOT.md`
- 只读取与当前任务直接相关的文件
- 修改前先说明要改哪些文件
- 修改后运行最小必要验证
- 不做顺手优化
...
`AGENTS.md` 与 `docs/SESSION_LOG.md` 是历史会话遗留文档（Cursor 主导开发期间使用）。
新流程下**不需要**在每个 session 开头阅读它们 —— 用 `docs/HANDOFF.md` + `docs/TASK_QUEUE.md` + `docs/ARCHITECTURE_SNAPSHOT.md` 代替。
