...
最后更新：**2026-06-27** · branch `master` · **Phase 0–7 accepted / merged**
...
1. 稳定化：整理 rollback/观测/legacy 清理计划；退役或收口兼容期 dual-write。
...
四条路线共享 **invariant 353** 回归门禁；语音轨额外遵守 voice 专项测试，但不反向改动 Soul Runtime 契约。
