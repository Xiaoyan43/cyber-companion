...
| ~~**P1-5**~~ | ~~Turn consistency backlog~~ | ✅ `docs/SOUL_RUNTIME_TURN_CONSISTENCY_BACKLOG.md`（2026-06-27） |
...
| `docs/SOUL_RUNTIME_TURN_CONSISTENCY_BACKLOG.md` | §5 turn 一致性缺口、P0/P1/P2 backlog、首项可实施任务 |
